...
public class CheckPermutation {
	...
	/**
	 * Check if first string is a permutation of the second: Sort the strings
	 * and compare each character: Complexity: O(nlogn)
	 * 
	 * @param first
	 * @param second
	...
	/**
	 * Check if first string is a permutation of the second: Use an Array[128]
	 * to maintain a counter for each character, decrement while checking the
	 * second String. If any value < 0 -> return false: Complexity: O(n), Space:
	 * O(1)
	 * 
	 * @param first
	 * @param second
